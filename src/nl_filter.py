...
PRICE / MARKET DATA (available for all 426 stocks):
...
- market_cap_cr (float): Market cap in Indian Crores. Large-cap > 20000, Mid-cap 5000–20000, Small-cap < 5000.

FUNDAMENTAL DATA (from Screener.in — available for cached stocks only; NULL for uncached stocks):
- pe_ratio (float): Stock P/E ratio
...
- profit_growth_yoy (float): Latest quarter net profit growth vs same quarter last year (%). Use for queries about quarterly earnings growth, YoY profit increase, etc.
- revenue_growth_yoy (float): Latest quarter revenue growth vs same quarter last year (%)

Indian number system — always convert before filtering:
- "1 lakh" = 100, "1 crore" = 1 (market_cap_cr is already in crores)
- "10,000 crores" → value: 10000, "1 lakh crore" → value: 100000
